...
return [
  'Job' => [
    'CounterJob' => [
      'CounterJob' => [
        'label' => 'Counter Job',
        'description' => 'Job to count records, users and disk size',
        'interval' => '0 0 * * *',
        'job' => 'Espo\\Modules\\Counter\\Jobs\\CounterJob'
      ]
    ]
  ],
  'aclDefs' => [
  ...
  'app' => [
    ...
    'metadata' => [
      ...
      'additionalBuilderClassNameList' => [
        0 => 'Espo\\Core\\Utils\\Metadata\\AdditionalBuilder\\FilterFields',
        1 => 'Espo\\Core\\Utils\\Metadata\\AdditionalBuilder\\Fields',
