...
define("modules/crm/views/record/panels/tasks", ["exports", "views/record/panels/relationship"], function (_exports, _relationship) {
  "use strict";
...
define("modules/crm/views/dashlets/activities", ["exports", "views/dashlets/abstract/base", "multi-collection"], function (_exports, _base, _multiCollection) {
  "use strict";
...
define("modules/crm/views/call/detail", ["exports", "crm:views/meeting/detail"], function (_exports, _detail) {
  "use strict";
...
define("modules/crm/handlers/task/reminders-handler", ["exports", "bullbone"], function (_exports, _bullbone) {
  ...
  class RemindersHandler {
    ...
    process() {
      this.control();
      this.listenTo(this.model, 'change', () => {
        if (!this.model.hasChanged('assignedUserId') && !this.model.hasChanged('assignedUsersIds')) {
          return;
        }
        this.control();
      });
...
define("modules/crm/handlers/opportunity/defaults-preparator", ["exports", "handlers/model/defaults-preparator"], function (_exports, _defaultsPreparator) {
  "use strict";
  ...
  // noinspection JSUnusedGlobalSymbols
  class _default extends _defaultsPreparator.default {
    prepare(model) {
